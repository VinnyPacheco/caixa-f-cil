...
export function BottomNav() {
  ...
  const isActive = (path: string) => {
    if (path === '/cadastros') {
      return location.pathname === '/accounts' || location.pathname === '/categories' || location.pathname === '/metas' || location.pathname === '/import-transactions' || location.pathname === '/bulk-transactions';
    }
  ...
  return (
    <nav className="fixed bottom-0 w-full bg-background/50 backdrop-blur-sm pb-safe pt-1 px-4 z-50 rounded-t-[28px] shadow-[0_-4px_30px_rgba(0,0,0,0.1)] md:hidden">
